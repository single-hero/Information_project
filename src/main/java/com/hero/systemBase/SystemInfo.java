...
public class SystemInfo {
    ...
    /**
     * 获取CPU序列号
     * 可以通过cmd 输入wmic CPU get ProcessorID 查看cpu
     * @return
     */
    ...
    public static Map<String, String> getAllSn(){
        ...
        if("LINUX".equals(os)) {
            ...
            String cpuid = SystemInfo.getCPUSerial();
            String mainboard = SystemInfo.getMotherboardSN();
            String disk = SystemInfo.getHardDiskSN("c");
