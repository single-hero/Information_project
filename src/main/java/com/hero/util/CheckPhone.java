...
public class CheckPhone {  
    ...
    private static final String PHONE_CALL_PATTERN = "^(\\(\\d{3,4}\\)|\\d{3,4}-)?\\d{7,8}(-\\d{1,4})?$";  
      ...
      * **/  
     private static final String CHINA_TELECOM_PATTERN = "(^1(33|53|70|77|8[019])\\d{8}$)|(^17\\d{9}$)";  
     ...
     * @author LinBilin 
     ...
     public static void main(String[] args) {  
         ...
         System.out.println(isPhoneNum("13450581369"));
        ...
        System.out.println(isPhoneNum("17750581369,13306061248"));  
         ...
         System.out.println(isPhoneNum("17012334455"));  
         System.out.println(isPhoneNum("17112334455"));  
